...
### Technology dossier artwork

**Source:** Original Ironfronts assets generated with OpenAI's built-in image
generator on 2026-09-14 and 2026-09-15. They were created for the six live research branches
and do not reproduce artwork from another game or third party.

**Direction:** grounded 1939 war-ministry illustration with readable silhouettes,
worn steel, oxidized brass, olive drab, faded paper, and warm desk-lamp light.
The six transparent emblems depict infantry fieldcraft, engineer corps, resource
infrastructure, training and industry, mobile artillery/reconnaissance support, and armored
warfare. Every prompt excluded text, flags, national or political insignia,
modern equipment, and watermarks.

The expanded suite adds a different panoramic environment for each branch and
one individually composed field plate for every one of the forty-eight technology
levels. Subjects range from infantry drill and signals through geological
survey, mines, railheads, industrial storage, factory instruction, mobile support,
and armored recovery, so no two
level cards reuse an illustration or composition.

**Generated sources:**

- `exec-b22e91da-afee-4367-841a-3dba7b755891.png` - Infantry Doctrine emblem
- `exec-87cada5d-2d37-43aa-b759-6eb17bd42573.png` - Resource Engineering emblem
- `exec-cf0f545a-4813-4e60-9a4d-ac4f88ca8210.png` - Training & Industry emblem
- `exec-ec471f43-ed19-42ae-ae67-01652b27673c.png` - Mobile Support emblem
- `exec-c1f47389-603c-46c6-b3a7-f94b65b7903f.png` - Armored Warfare emblem
- `exec-59a89943-ce05-4145-a130-4b1652a98012.png` - Resource Infrastructure emblem
- Branch backdrops: `exec-404eacab-f090-44a9-abe0-e32a5cf16f32.png` (infantry),
  `exec-361b55b1-b404-41c9-829b-9452d1eb9a6e.png` (resources),
  `exec-136c0bb1-757d-494e-a8ce-6a9fd3ed96b1.png` (training),
  `exec-b1ba0441-657e-4a37-baa9-c8ab9853ab29.png` (mobile support), and
  `exec-ffc13976-4499-4637-a88b-0e211bf49272.png` (armored)
- Resource Infrastructure backdrop: `exec-d784f0f5-53ab-4817-b856-408014eadfc2.png`
- Resource Infrastructure levels I-VIII: eight distinct panels cropped from the
  generated contact sheet `exec-145a1400-0877-40b0-affb-c32855607a92.png`
- Infantry levels I-VIII: `exec-aeebedca-699a-478c-9703-a2d3bd4c6c38.png`,
  `exec-c03c22d5-0539-419f-ba9b-590bc8c812e5.png`,
  `exec-b6bd4c15-d6c7-4bb4-9b23-54afca6974ef.png`,
  `exec-b898d9b7-a3fd-4ed5-8212-881c56521163.png`,
  `exec-bb4eed25-c716-4b1b-b740-de439e046f5a.png`,
  `exec-9d7c164b-2e77-45d7-b10d-b01207e1d1bd.png`,
  `exec-214dee89-5b2c-44fe-9c29-26af62c87ef8.png`, and
  `exec-260b4471-fda9-4382-aa87-267a13715f4b.png`
- Resource levels I-VIII: `exec-f1d887d7-280b-4f2a-b42a-137b1395ddcd.png`,
  `exec-bdc75cef-113e-43af-b183-495f8a83fba8.png`,
  `exec-a1cc7704-a843-4387-b7e5-d30a3b435497.png`,
  `exec-f71a7ed6-0418-479d-a832-fc100b5eb914.png`,
  `exec-4838070e-aef3-46d2-90a7-a138878efde2.png`,
  `exec-c5a96eca-0c4b-4475-8de7-915131de815f.png`,
  `exec-62e8be85-c5bd-49ce-a76b-fa7beb49c2c9.png`, and
  `exec-49e6a359-dd80-497d-9323-fbf30e61f3f9.png`
- Training levels I-VIII: `exec-24f871fa-c8c2-47b4-89a7-8f83e8c12981.png`,
  `exec-adaf7a25-0441-4c9a-a834-4e18c95be438.png`,
  `exec-ba905d3f-0e54-4ccd-97ea-d04bb3effb70.png`,
  `exec-e7f89c6f-8baf-4091-8cf7-4f00f931c20d.png`,
  `exec-98183f51-8e5e-4dc1-be15-fa80dd3a6375.png`,
  `exec-4e7921dd-0399-4d09-b7d8-352af5e8405b.png`,
  `exec-1b2b4224-8458-4a51-8db3-9706f0f05dfa.png`, and
  `exec-de8e259d-97b2-4691-8905-6910b19bd881.png`
- Mobile-support levels I-VIII: `exec-a7751a72-1f91-49b2-b495-3b05931dcd1d.png`,
  `exec-eea12f74-453e-49da-82bd-c106d2438a4f.png`,
  `exec-0bf3e148-dee1-433d-b6c4-f73216b8cb4f.png`,
  `exec-8c88098a-eda5-4b8d-a032-3f5419767216.png`,
  `exec-8c5224b6-b9c7-4d6e-a6c7-2ec5afa9fa1f.png`,
  `exec-6ad74678-1c37-414e-86ad-03d8e49ff26b.png`,
  `exec-90dfd831-c07a-49b3-99e1-3fc5702d56d1.png`, and
  `exec-df70503d-ec7d-445e-8f3e-377813acb4e4.png`
- Armored levels I-VIII: `exec-7298c73b-33ac-4f30-b0d9-efc54eefc928.png`,
  `exec-17c079e2-4293-47ad-ae97-8243d7bdb3b3.png`,
  `exec-a1c16fd8-68fc-4c20-8471-015cc5c1af39.png`,
  `exec-9d852da3-176b-4f2d-acc6-c2db047012f6.png`,
  `exec-ef081875-63fe-4468-a7fe-c1995f3ccccb.png`,
  `exec-1b876edf-08c6-493b-b7ce-8edfbd0e2fd0.png`,
  `exec-b05ccb00-91a0-44d7-806a-1bbfc346b1a6.png`, and
  `exec-830ebd06-7f8c-47e6-959f-94947124abe2.png`

Sources are retained under
`C:\Users\dimah\.codex\generated_images\01a0a096-a1e7-77a3-bec2-3e1f127fb032`.
`scripts/prepare-generated-ui-skins.mjs` alpha-trims and Lanczos-downscales the
emblems to 256x256 RGBA, the six branch backdrops to 1200x500, and the forty-eight
level plates to 256x160. The source lists above map to runtime files in branch
and level order. The opaque backdrops and level plates are JPEG-encoded at
quality 86 after resizing; together those 54 field-art files are about 1.46 MB.
Transparent emblems stay PNG. Rebuild each item with
`node scripts/prepare-generated-ui-skins.mjs --output-dir=src/ui/assets/technology name=source.png@WIDTHxHEIGHT`,
using 256x256 for emblems, 1200x500 for backdrops, and 256x160 for level plates,
then apply the documented JPEG settings to the opaque outputs.

| Runtime file | Use |
|---|---|
| `src/ui/assets/technology/infantry.png` | Infantry Doctrine branch emblem |
| `src/ui/assets/technology/resources.png` | Resource Engineering branch emblem |
| `src/ui/assets/technology/resource-buildings.png` | Resource Infrastructure branch emblem |
| `src/ui/assets/technology/training.png` | Training & Industry branch emblem |
| `src/ui/assets/technology/hybrid.png` | Mobile Support branch emblem |
| `src/ui/assets/technology/armored.png` | Armored Warfare branch emblem |
| `src/ui/assets/technology/backdrop-{branch}.jpg` | Six branch-specific panoramic dossier environments |
| `src/ui/assets/technology/{branch}-{1..8}.jpg` | Forty-eight unique technology-level field plates |
