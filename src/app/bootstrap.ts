...
import type { FrameStats, HoverInfo } from '../rendering/types';
...
import { isMapMode, required, safeLocalStorage } from './dom';
import { formatBytes, formatCompact } from './formatting';
